...
local function Reroll()
    ...
    if math.Round(math.Rand(1, 100)) <= nature.drop then
...
concommand.Add("ng_reroll_test_probability", function(ply, cmd, args)
    print(" ")
    print(" ")
    print("Reroll Test Probability")
    print(" ")
    print("Taille de l'echantillon : 10 000")
    print(" ")
    ...
    for i = 1, 10000 do
        local chance = Reroll()
        SortNature[chance] = (SortNature[chance] or 0) + 1
    end

    PrintTable(SortNature)
end)
