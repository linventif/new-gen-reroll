...
local function RerollMenu(data)
    ...
    frame.Paint = function(self, w, h)
        ...
        local nature = data.nature
        if NGReroll.Config.Nature[data.nature] && NGReroll.Config.Nature[data.nature].name then
            nature = NGReroll.Config.Nature[data.nature].name
        end
        draw.SimpleText("Nature : " .. nature, "LinvFontRobo20", RespW(140), RespH(230), Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
